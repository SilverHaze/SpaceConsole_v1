...
namespace SpaceConsole
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Ship shipOrca = new Ship("Orca I", "Orca", 700, 40000, 160, "Capacité Moyenne", "Accessible, ce vaisseau puissant est un compromis idéal, du fait de sa capacité respectable et de son coût.");
